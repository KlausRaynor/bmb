...
<div id='wrapper'>
        <div id='header'>
            <header>
                ...
                <h1 id='topBanner'>Bite Me Bouquet<em>&trade;</em></h1>

            </header>
        </div>
        <div id='content'>
            <ul id='changer'><!--Javascript bg:color changer-->
            ...
            <h2 id='galleryBanner'>Gallery</h2>
            ...
            <div id="gallery">
                <ul>
                    ...
                    <li>
                        <a href="images/lovebirds.jpg" title="Love Bird Bouquet" data-gallery>
                            <img src="images/thumbnails/lovebirds.png" alt="lovebirds">
                        </a>
                    </li>
                </ul>
            </div>
